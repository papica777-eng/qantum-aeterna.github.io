 ...
 * 
 * Usage:
 *   npm run cybercody:audit -- <url> [options]
 *   npx tsx security/cybercody-cli.ts ghost-audit <url> [options]
 * 
 * Commands:
...
async function main(): Promise<void> {
  ...
  if (!options.url) {
    ...
    console.error('Usage: npm run cybercody:audit -- <url> [options]');
    process.exit(1);
  }
...
Examples:
  ...
  npm run cybercody:audit -- https://app.revolut.com --screenshots

  # Full stealth audit with AI annotations
  npm run cybercody:audit -- https://app.revolut.com \\
    --mode safe-hunter \\
    --stealth \\
    --multi-user \\
    --headless=false \\
