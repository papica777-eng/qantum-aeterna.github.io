 ...
 */
export type BrainActivityType = 'IDLE' | 'ANALYZING' | 'PLANNING' | 'EXECUTING' | 'LEARNING' | 'HEALING' | 'PREDICTING' | 'OPTIMIZING';
/**
 ...
 */
export type WSMessageType = 'SUBSCRIBE' | 'UNSUBSCRIBE' | 'REQUEST_SNAPSHOT' | 'EXECUTE_COMMAND' | 'PING' | 'BRAIN_WAVES' | 'HARDWARE_TELEMETRY' | 'TEST_UPDATE' | 'LOG_ENTRY' | 'ALERT' | 'SNAPSHOT' | 'COMMAND_RESULT' | 'PONG' | 'ERROR';
/**
 * Subscription channels
 */
export type WSChannel = 'brain-waves' | 'hardware-telemetry' | 'test-execution' | 'logs' | 'alerts' | 'all';
/**
 ...
 */
export type WSConnectionState = 'CONNECTING' | 'CONNECTED' | 'AUTHENTICATED' | 'DISCONNECTED' | 'RECONNECTING' | 'ERROR';
/**
 ...
 */
export type DashboardView = 'overview' | 'brain-waves' | 'hardware' | 'tests' | 'logs' | 'settings';
/**
 * Dashboard theme
 */
...
//# sourceMappingURL=websocket-protocol.types.d.ts.map