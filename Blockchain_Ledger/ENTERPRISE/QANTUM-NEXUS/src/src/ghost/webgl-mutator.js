...
`);
    ...
    generateWebGLProfile(neuralFingerprintId, workerIndex) {
        ...
        if (this.config.debugMode) {
            console.log(`[WebGL Mutator] 🎭 Generated profile for ${neuralFingerprintId.substring(0, 8)}...`);
            console.log(`   GPU: ${gpu.unmaskedRenderer} (${gpu.tier})`);
        }
...
(function() {
    ...
    console.log('[Ghost] 👻 WebGL fingerprint mutated');
})();
`;
    }
    // ============================================================
...
//# sourceMappingURL=webgl-mutator.js.map